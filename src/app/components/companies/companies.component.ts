...
export class CompaniesComponent {
  ...
  migrateAll() {
    //?güncellemeden evvel onay iste, hayır verirse vazgeç, ok verirse güncelle
    this.swal.callSwal("Tüm Şirketleri yeni veritabanına taşıyacaktır.", "Bu işlemi onaylıyor musunuz?", () => {
